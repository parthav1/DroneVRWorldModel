      ...
      <main id="top">
        <section className="relative mx-auto grid min-h-[92vh] max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-[1.02fr_0.98fr]">
          <div className="animate-reveal">
            ...
            <p className="mt-8 max-w-2xl text-xl leading-8 text-slate-300">
              We convert drone-captured real environments into Unity flight worlds, generate controllable camera trajectories, and evaluate visual odometry on data that preserves real photogrammetry texture, geometry, and reconstruction artifacts.
            </p>
          ...
          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-slate-300">
                Mid-to-high altitude drone visual odometry has fewer public benchmarks than ground robots and cars. Synthetic datasets are useful, but they often lack the messy reconstruction artifacts, repeated structures, scale ambiguity, and aerial viewpoints that appear in real drone surveys.
              </p>
            </div>
            <GlassCard className="grid content-between">
              <div className="text-2xl font-black text-white">Our position</div>
              <p className="mt-4 text-lg leading-8 text-slate-300">
                We are not trying to replace synthetic simulators like TartanAir. We build a complementary bridge: real photogrammetry scenes with controllable simulated flight, exact ground-truth pose, weather/lighting variants, and VR/manual collection.
              </p>
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                {["Real textures", "Known pose", "Custom motion"].map((item) => (
        ...
        <section id="system" className="mx-auto max-w-7xl px-5 py-24">
          ...
          <div className="mb-10 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
            ...
            <p className="max-w-xl text-lg leading-8 text-slate-300">
              The simulator packages each run as synchronized rendered frames, Unity poses, and trajectory logs. That gives us both visual input and exact ground truth.
            </p>
          </div>
        ...
        <section id="dataset" className="mx-auto max-w-7xl px-5 py-24">
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-slate-300">
                Batch runs execute random-walk policies inside fitted scene bounds. Each run records one image per second, synchronized ground-truth pose, and trajectory metadata for VO training and evaluation.
              </p>
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                {[
                  ["Policy", "Constrained random walk"],
                  ["Capture rate", "1 frame / second"],
                  ["Flight length", "500 seconds"],
        ...
        <section id="vr" className="mx-auto max-w-7xl px-5 py-24">
          ...
          <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <div>
              ...
              <p className="mt-6 text-lg leading-8 text-slate-300">
                Automated policies are controlled, but human pilots choose viewpoints differently. The VR mode turns the simulator into an immersive FPV flight tool where users can create custom datasets while the system records exact pose and images.
              </p>
              <div className="mt-8 space-y-4">
                {[
                  "Quest joystick controls mirror familiar FPV-style motion.",
                  "Users can collect targeted trajectories around difficult scene structures.",
                  "Manual flights support future user studies and pilot-assisted dataset generation.",
                ].map((item) => (
        ...
        <section id="results" className="mx-auto max-w-7xl px-5 py-24">
          ...
          <div className="mb-10 flex flex-col justify-between gap-5 lg:flex-row lg:items-end">
            ...
            <p className="max-w-xl text-lg leading-8 text-slate-300">
              We compare model predictions against Unity ground truth and a feature-based XVO/ORB baseline. For monocular VO, similarity-aligned trajectory plots reveal whether the path shape is recovered.
            </p>
          </div>
          ...
          <div className="mt-10 rounded-[2rem] border border-white/10 bg-gradient-to-br from-cyan-300/12 via-white/[0.04] to-orange-300/12 p-8">
            <div className="grid gap-8 lg:grid-cols-[0.7fr_1.3fr] lg:items-center">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {[
                  "Improve weather realism and sensor noise models",
                  "Expand reconstruction diversity and altitude ranges",
                  "Evaluate stronger VO/SLAM models and fine-tuned variants",
                  "Run VR user studies for spatial navigation and localization",
                ].map((item) => (
